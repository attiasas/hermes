...
public final class TeaVMBuilder {
  ...
  public static void main(String[] args) throws IOException {
    ...
    writeRuntimeProperties(runtimeConfigDir, applicationClass, debug, title, width, height);
  ...
  private static void writeRuntimeProperties(
      File dir, String applicationClass, boolean debug, String title, int width, int height)
      throws IOException {
